...
(async () => {
  ...
  await page.goto('https://dashboard.jabuti.ai/meta/broadcasts/edit/01KZEWTEB6036G0C5KR22MRY81', { waitUntil: 'networkidle' });
  await page.waitForTimeout(500);
  await page.screenshot({ path: 'scripts/out/62-broadcast-edit-page.png', fullPage: true });
